...
callBtn.addEventListener("click", function () {
  ...
  console.log('signalling state after',signallingState2)
    ...
    document.getElementById('callOngoing').style.display = 'flex';
...
function gotMessageFromServer(message) {
  ...
  switch(data.type) { 
    ...
    case "newusers": 
      ...
      var allAvailableUsers = data.allUsers.join();    
      showAllUsers.innerHTML = 'Available users: '+allAvailableUsers;
    break; 
...
function handleOffer(offer, name) { 
  document.getElementById('callInitiator').style.display = 'none';
  document.getElementById('callReceiver').style.display = 'flex';
  remoteUsernameShow.innerHTML = name+ " connected";
...
declineBtn.addEventListener("click", function () {
  document.getElementById('callInitiator').style.display = 'flex';
  document.getElementById('callReceiver').style.display = 'none';
...
function gotRemoteStream(event) {
  ...
  console.log(event)
  remotevideowrap.classList.remove("hide")
  remotevideowrap.classList.add("show")
...
function handleLeave() { 
  ...
  remotevideowrap.classList.remove("show")
  remotevideowrap.classList.add("hide")
...
{
  console.log("handleGuestLeft")
  console.log(remoteUsernameShow.innerHTML)
  handleLeave()
}
